...
export default function PostsClient({ petId, ownerInfo, emergencyInfo, isPublic = false }: Props) {
  ...
  return (
    <div className="space-y-5 bg-transparent text-black">
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          {!isPublic && (
            <button
              ...
              className="px-4 py-2 rounded-full text-sm font-medium shadow-lg hover:shadow-xl transition-all bg-[#EC5914] text-white"
            >
              + Create
            </button>
          )}
      ...
      {showPopup && selectedPost && (
        ...
        >
          <div 
            className="bg-[#f5f5dc] text-black rounded-2xl max-w-lg w-full max-h-[90vh] overflow-hidden shadow-2xl transform transition-all duration-300 scale-100"
      ...
      {showDeleteModal && (
        ...
        >
          <div 
            className="bg-[#f5f5dc] text-black rounded-2xl max-w-md w-full p-6 shadow-2xl transform transition-all duration-300 scale-100"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Icon */}
